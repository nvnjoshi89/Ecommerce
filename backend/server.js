...
// By using cors any websites with any domain name can access the data from our API . Enable CORS middleware for all routes
app.use(cors())
// Allow requests from localhost:3000 (or your frontend URL). confuguring CORS to allow requests from specific origins/routes/websites
// const corsOptions = {
...
// __filename: This global variable returns the absolute path of the currently executing file, including the file name.
// /home/user/project
//   ├── app.js
//   └── data
//       └── file.txt
// __filename: /home/user/project/app.js

// __dirname is a global variable that represents the directory name of the current module. It returns the absolute path of the directory containing the currently executing file.__dirname: /home/user/project

// An absolute path is a complete path to a file or directory, starting from the root of the filesystem.
// Absolute path to app.js: C:\Users\user\project\app.js
// Absolute path to the data directory: C:\Users\user\project\data
// Absolute path to file.txt: C:\Users\user\project\data\file.txt

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
// console.log(__filename) filename E:\full stack projects\Ecommerce\backend\server.js
// dirname E:\full stack projects\Ecommerce\backend
...
// use compression middleware for compression http request which will improve performance
app.use(compression())


// Define BASE_DIR and BASE_URL
// 1. .. means to move up one directory level from E:\full stack projects\Ecommerce\backend, which takes you to E:\full stack projects\Ecommerce.
// 2. Then backend/public is appended to E:\full stack projects\Ecommerce, resulting in E:\full stack projects\Ecommerce\backend\public.
//  here __dirname will give you absolute path where your server.js is i.e E:\full stack projects\Ecommerce\backend\src after ../public it will remove src and add /public i.e  E:\full stack projects\Ecommerce\backend\public.. this is not applied here it is for future correction
