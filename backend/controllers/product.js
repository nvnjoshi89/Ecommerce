...
export const createProduct = async (req, res) => {
    try {
        // req.file.path will hold the path to the uploaded file, which is determined by the destination and filename properties defined in multerStorage. In your setup, the destination is ${BASE_DIR}/documents/temp and the filename is a timestamp followed by the original file name.
